...
public class Mago implements IAdivinador {
	...
	// el argumento
	@Pointcut("execution( * org.certificatic..IVoluntario.pensar*(String) ) && args(pensamiento)")
	...
	// argumento
	@Pointcut("execution( * org.certificatic..IVoluntario.getP*(boolean) ) && args(hacerTrampa)")
