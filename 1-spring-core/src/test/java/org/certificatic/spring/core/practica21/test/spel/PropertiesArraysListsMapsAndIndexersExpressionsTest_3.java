...
public class PropertiesArraysListsMapsAndIndexersExpressionsTest_3 {
	...
	public void propertiesSpelTest() {
		...
		int teslaBirthYear = spelParser.parseExpression("birthdate.year + 1900").getValue(teslaContext, Integer.class); // definir y obtener el valor de la expresion "birthdate.year + 1900" en el contexto teslaContext
	...
	public void arraysSpelTest() {
		...
		String invention_2 = spelParser.parseExpression("inventions[2]").getValue(teslaContext, String.class); // definir expresion que corresponda con obtener el valor del invento posicion 2 de Tesla
	...
	public void listSpelTest() {
		...
		Inventor teslaInventor = null; // definir expresion que corresponda con obtener el valor del miembro posici�n 2 del contexto society
		...
		// utilizando el contexto society, obtener el nombre del invento posicion 1 del miembro posicion 2, 
		// obener utilizando posicion en el arreglo
		String otherInventionName_1 = spelParser.parseExpression("getMembers()[2].getInventions()[1]").getValue(societyContext, String.class); 
