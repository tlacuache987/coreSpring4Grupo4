...
public class UserSpringJdbcDAO extends GenericSpringJdbcDAO<User, Long> implements IUserDAO {
	...
	public void update(User user) {
		 ...
		 * user.getCustomer().getName(), user.getCustomer().getLastName(),
	...
	public User delete(User user) {
		...
		// Pasar parametros a update
		this.jdbcTemplate.update(DELETE_USER_WHERE_USER_ID, new Object[] { user.getId() });

		// Pasar parametros a update
		this.jdbcTemplate.update(DELETE_CUSTOMER_WHERE_CUSTOMER_ID, new Object[] { user.getCustomer().getId() });
